...
function Footer() {
  return (
    <div data-scroll  data-scroll-speed='0.5' className='flex gap-5 w-full h-screen bg-zinc-900 p-20 '>
        <div className='w-1/2  h-full flex flex-col justify-between '>
           <div>
           <h1 className='text-[6vw] font-semibold uppercase  leading-none -mb-10'>EYE- <br />
OPENING</h1>
           </div>
<svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div>
            <a className='block text-xl font-light mt-10' href="#">
                Facebook
                </a>
                <a className='block text-xl font-light mt-10' href="#">
                    Twitter
